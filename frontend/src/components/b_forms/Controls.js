          ...
          <div className='dashControls'>
            ...
            {count.total ?
              <div className='dashControl'>
                ...
                <label>Caixa</label>
                <p>Confirmado: {count.valor_pago.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
                <p>Pendente: {(parseInt(count.valor_total) - parseInt(count.valor_pago)).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
                <p>Valor Total: {count.valor_total && count.valor_total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
