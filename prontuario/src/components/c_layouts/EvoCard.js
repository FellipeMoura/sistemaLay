    ...
    function Card({ session }) {
        ...
        const Label =(
            ...
            <div className='sHeader'>
                ...
                <label>Data: <label className="value"> {data.substr(0, 10).split('-').reverse().join('/')}</label></label>
            ...
            <label>Estado do paciente: <label className="value"> {session.estado}</label></label>       
